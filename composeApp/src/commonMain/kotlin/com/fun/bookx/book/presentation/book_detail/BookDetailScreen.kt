...
import com.`fun`.bookx.book.presentation.book_detail.components.BlurredImageBackground
import com.`fun`.bookx.book.presentation.book_detail.components.BookChip
import com.`fun`.bookx.book.presentation.book_detail.components.ChipSize
import com.`fun`.bookx.book.presentation.book_detail.components.TitledContent
import com.`fun`.bookx.core.presentation.SandYellow
